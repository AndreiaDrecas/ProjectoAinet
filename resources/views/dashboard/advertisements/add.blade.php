...
<form action="{{url('advertisements/create')}}" method="post" class="form-group">
    {{ csrf_field() }}
    <input type="text" class="form-control" name="owner_id" id="inputOwner_id" value="15"/>
    <div class="form-group">
        <label for="inputFullname">Name</label>
        <input type="text" class="form-control" name="name" id="inputName" placeholder="Name" value="" />
    </div>
    <div class="form-group">
        <label for="inputDescription">Description</label>
        <input type="text" class="form-control" name="description" id="inputDescription" placeholder="Description" value="" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="tradepref" id="inputTradePref" 
